      ...
      <Stack gap="md">
        ...
        <div style={{ overflowX: 'auto' }}>
          <div style={{ display: 'flex', gap: cellGap }}>
            {/* Day labels column */}
            {showDayLabels && (
              <div style={{ display: 'flex', flexDirection: 'column', gap: cellGap, marginRight: 8 }}>
            ...
            <div>
              {/* Month labels */}
              {showMonthLabels && (
                <div style={{ display: 'flex', gap: cellGap, marginBottom: 4, height: 16 }}>
...
export function ActivityHeatmapCompact({
  ...
  const maxDay = activities.reduce((max, a) => (a.count > max.count ? a : max), activities[0] || { count: 0, date: '' });
