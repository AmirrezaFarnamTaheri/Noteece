...
const ONBOARDING_STEPS: OnboardingStep[] = [
  {
    ...
    features: ['End-to-end encryption', 'Local-first, offline-capable', 'Zero-knowledge architecture'],
  },
  {
    icon: 'flash',
    ...
    features: ['Daily briefs and predictions', 'Burnout risk analysis', 'Smart recommendations'],
  },
  {
    icon: 'git-network',
    title: 'Seamless Local Sync',
    description: 'Sync securely between your devices on your local network. No cloud required.',
    features: ['Peer-to-peer encryption', 'Automatic conflict resolution', 'Background sync'],
  },
  {
    icon: 'rocket',
    title: 'Physical-Digital Bridge',
    description: 'Use NFC tags and geofencing to blend your digital and physical workflows.',
    features: ['NFC trigger actions', 'Location-based reminders', 'Quick capture shortcuts'],
  },
];
    ...
    <View style={styles.stepContainer}>
      <View style={styles.stepContent}>
        ...
        <View style={styles.textContent}>
          ...
          <Text style={styles.stepDescription}>Choose a strong password. This encrypts all your data locally.</Text>
          ...
          <View style={styles.securityNotice}>
            ...
            <Text style={styles.securityNoticeText}>This password cannot be recovered. Store it safely.</Text>
          </View>
        </View>
      </View>
    </View>
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top', 'bottom']}>
      ...
      >
        ...
        >
          {ONBOARDING_STEPS.map((step, index) => renderFeatureStep(step, index))}
          {renderPasswordStep()}
        </ScrollView>
        ...
        <View style={styles.navigation}>
          ...
          {isPasswordStep ? (
            ...
            >
              <LinearGradient
                colors={isCreating ? ['#4B5563', '#6B7280'] : ['#6366F1', '#8B5CF6']}
                style={styles.createButtonGradient}
                start={{ x: 0, y: 0 }}
                end={{ x: 1, y: 0 }}
              >
                <Text style={styles.createButtonText}>{isCreating ? 'Creating...' : 'Create Vault'}</Text>
                {!isCreating && <Ionicons name="arrow-forward" size={24} color="#FFFFFF" />}
              </LinearGradient>
            </TouchableOpacity>
          ) : (
            <TouchableOpacity style={styles.nextButton} onPress={handleNext}>
              ...
              >
                <Text style={styles.nextButtonText}>{isLastFeatureStep ? 'Get Started' : 'Next'}</Text>
