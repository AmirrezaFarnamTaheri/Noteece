...
export function SocialAnalytics() {
  ...
  if (error) {
    return <ErrorFallback error={error} message="Failed to load analytics" onRetry={loadAnalytics} />;
  }
            ...
            {categoryStats.slice(0, 10).map((stat, index) => (
              <View key={stat.category_id} style={styles.categoryRow}>
                ...
                <View style={styles.categoryInfo}>
                  {stat.color && <View style={[styles.categoryColorDot, { backgroundColor: stat.color }]} />}
                  <Text style={styles.categoryName}>{stat.category_name}</Text>
                </View>
                <Text style={styles.categoryCount}>{stat.post_count} posts</Text>
              </View>
            ))}
          </View>
        ) : (
        ...
        <View style={styles.insightsList}>
          {platformStats.length > 0 && (
            <View style={styles.insightItem}>
              ...
              <Text style={styles.insightText}>
                Most active platform: <Text style={styles.insightBold}>{platformStats[0]?.platform || 'N/A'}</Text> (
          ...
          {categoryStats.length > 0 && (
            <View style={styles.insightItem}>
              ...
              <Text style={styles.insightText}>
                Top category: <Text style={styles.insightBold}>{categoryStats[0]?.category_name || 'N/A'}</Text> (
          ...
          <View style={styles.insightItem}>
            ...
            <Text style={styles.insightText}>
              ...
              <Text style={styles.insightBold}>
                {platformStats.length > 0 ? Math.round(totalPosts / platformStats.length) : 0}
              </Text>
            </Text>
          </View>
