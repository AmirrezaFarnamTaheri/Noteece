...
const APPS: SocialAppProps[] = [
  ...
  },
  {
    name: 'Tumblr',
    pkg: 'com.tumblr',
    icon: 'alpha-t-box', // tumblr alternative
    color: '#35465C',
    category: 'social',
  },
  ...
  // Messaging
  {
    ...
    icon: 'send', // telegram not in older material sets sometimes, send is close
    color: '#26A5E4',
    category: 'messaging',
  },
  {
    name: 'Discord',
    pkg: 'com.discord',
    icon: 'gamepad-variant', // discord not always available
    color: '#5865F2',
    category: 'messaging',
  },
  {
