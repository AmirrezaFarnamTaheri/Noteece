...
#[tauri::command]
pub fn delete_caldav_account_cmd(
    db: State<DbConnection>,
    account_id: String,
) -> Result<(), String> {
    crate::with_db!(db, conn, {
...
#[tauri::command]
pub fn sync_caldav_account_cmd(
    db: State<DbConnection>,
    account_id: String,
...
#[tauri::command]
pub fn get_caldav_sync_history_cmd(
    db: State<DbConnection>,
    account_id: String,
...
#[tauri::command]
pub fn get_caldav_conflicts_cmd(
    db: State<DbConnection>,
    account_id: String,
...
#[tauri::command]
pub fn resolve_caldav_conflict_cmd(
    db: State<DbConnection>,
    conflict_id: String,
    resolution: ConflictResolution,
) -> Result<(), String> {
    crate::with_db!(db, conn, {
        core_rs::caldav::resolve_conflict(&conn, &conflict_id, resolution)
            .map_err(|e| e.to_string())
    })
}
