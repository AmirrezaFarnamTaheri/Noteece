...
const DEFAULT_WIDGETS: WidgetConfig[] = [
  {
    id: 'quickStats',
    name: 'Quick Stats',
    description: 'Overview of notes, tasks, and projects',
    enabled: true,
  ...
  },
  {
    id: 'social',
    name: 'Social Feed',
    description: 'Aggregated social posts',
    enabled: false,
    category: 'social',
    size: 'large',
    order: 9,
...
const DEFAULT_FEATURES: FeatureConfig[] = [
  ...
  { id: 'cloudAI', name: 'Cloud AI', description: 'Cloud-based AI providers', enabled: false, category: 'ai' },
  {
    id: 'aiInsights',
    name: 'AI Insights',
    description: 'AI-powered correlation insights',
    enabled: true,
    category: 'ai',
  },
  ...
  { id: 'socialHub', name: 'Social Hub', description: 'Social media aggregation', enabled: false, category: 'social' },
  {
    id: 'socialCapture',
    name: 'Social Capture',
    description: 'WebView content capture',
    enabled: false,
    category: 'social',
    beta: true,
  },
  ...
  },
  {
    id: 'automation',
    name: 'Automation',
    description: 'Workflow automation DSL',
    enabled: false,
    category: 'advanced',
    beta: true,
  },
